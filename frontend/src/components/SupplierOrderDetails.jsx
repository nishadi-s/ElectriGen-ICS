          ...
          <tr>
            ...
            <td>
              {order.items.map((item, index) => (
                <div key={index}>
                  <p>
                    <strong>Item {index + 1} Material Code: </strong>
                    {item.Sup_matrial_code}
                  </p>
                  <p>
                    <strong>Item {index + 1} Material Name: </strong>
                    {item.M_Name}
                  </p>
                  <p>
                    <strong>Item {index + 1} Quantity: </strong>
                    {item.Sup_Quant}
                  </p>
                </div>
              ))}
            ...
            <td>
              <button className="Sup_button1" onClick={handleEdit}>
                Edit
              </button>
              <br />
              <br />
              <button onClick={handleClick} className="Sup_button2">
                Delete
              </button>
            </td>
          </tr>
