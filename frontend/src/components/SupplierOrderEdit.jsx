    ...
    if (newItem.Sup_matrial_code && newItem.M_Name && newItem.Sup_Quant) {
      ...
      try {
        ...
        const materialResponse = await fetch(
          `http://localhost:4000/api/materials/code/${newItem.Sup_matrial_code}`
        );
        ...
        const updateMaterialResponse = await fetch(
    ...
    <NavbarNishadi>
      <form className="update-supplier-order">
        ...
        <input
          ...
          className={
            emptyFields.includes("Supplier Material Code") ? "error" : ""
          }
        />
        ...
        <input
          ...
          className={
            emptyFields.includes("Supplier Material Name") ? "error" : ""
          }
        />
        ...
        <input
          ...
          value={Sup_Ord_sts}
          className={
            emptyFields.includes("Supplier Order Status") ? "error" : ""
          }
        />
        ...
        <button
          ...
          onClick={handleEditSupplierOrder}
        >
          Update the Order
        </button>
