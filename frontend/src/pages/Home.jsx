...
const Home = () => {
  const buttons = [
    ...
    { id: 3, text: "Distributors", link: "/login" },
    ...
    { id: 8, text: "Distributor Management", password: "Dd123", link: "/DisMDashboard" }
  ];

  const handleButtonClick = (password, link) => () => {
    if (link === "/login") {
      window.location.href = link; // Redirect to the login page
  ...
  return (
    <div className="container-fluid" style={{ backgroundImage: `url(${bg001})`, backgroundSize: 'cover', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
