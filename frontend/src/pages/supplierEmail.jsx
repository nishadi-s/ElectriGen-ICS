...
const SupplierEmail = () => {
  ...
  return (
    <NavbarNishadi>
        <h1> Sending Email </h1>
      <Box display="flex" justifyContent="center" alignItems="center" minHeight="90vh"> {/* Decreased the minHeight */}
            ...
            <Box p={3} boxShadow={3} borderRadius={4} bgcolor="white">
              ...
              <form ref={form} onSubmit={sendEmail}>
                <Grid container spacing={2}>
                  <Grid item xs={12}>
                    <TextField fullWidth label="Name" name="from_name" variant="outlined" />
                  </Grid>
                  <Grid item xs={12}>
                    <TextField fullWidth label="Email" name="from_email" variant="outlined" />
                  </Grid>
                  <Grid item xs={12}>
                    <TextField
                      fullWidth
                  ...
                  <Grid item xs={12}>
                    <Button className='Sup_button' type="submit" variant="contained"  fullWidth>
                      Send
                    </Button>
                  </Grid>
                </Grid>
